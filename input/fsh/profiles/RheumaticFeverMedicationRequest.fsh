...
Id: nz-rheumaticfever-medicationrequest
...
* extension[medicationFrequency] ^short = "Sets a standard interval between RF secondary prophylaxis medication appointments."
