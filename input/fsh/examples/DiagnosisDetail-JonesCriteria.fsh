...
* component[+] insert ObservationAbsent(  200951007,        [[Erythema marginatum in acute rheumatic fever (disorder)]], unknown, [[Unknown]] )
 
* component[+] insert ObservationPresent( 111211002,        [[Migratory polyarthritis (disorder)]], true  )
* component[+] insert ObservationAbsent(  699462004,        [[Monoarthritis (disorder)]], unknown, [[Unknown]]  )
